...
.product-col-left{
    background: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.3)), url("https://boldoutline.in/wp-content/uploads/2021/05/Web-cover-101.jpg") center/cover no-repeat;
}
.product-col-r-top{
...
.product-col-r-bottom > div:first-child{
    background: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.3)), url("https://www.pinkvilla.com/imageresize/7_summer_dresses_to_grab_from_amazon_sale_that_are_perfect_for_your_beach_vacay.jpg?width=752&format=webp&t=pvorg") center/cover no-repeat;;
}
.product-col-r-bottom > div:last-child{
    background: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.3)), url("https://cdn2.vectorstock.com/i/1000x1000/91/56/summer-sale-collection-background-design-vector-7969156.jpg") center/cover no-repeat;
}
.product-col-content{
    text-align:center;
    color: white;
                ...
                <div class = "product-collection-wrapper">
                    ...
                    <div class = "product-col-left flex">
                        <div class = "product-col-content">
                            <h2 class = "md-title" style="color: crimson;">New collection - women & men </h2>
                    ...
                    <div class = "product-col-right">
                        <div class = "product-col-r-top flex">
                            <div class = "product-col-content">
                                ...
                                <h2 class = "md-title" style="color: crimson;"> kids collection </h2>
                                <button type = "button" class = "btn-dark">Shop now</button>
                            </div>
                        </div>
                        ...
                        <div class = "product-col-r-bottom">
                            ...
                            <div class = "flex">
                                <div class = "product-col-content">
                                    <h2 class = "sm-title summer">Clothing sale mela </h2>
